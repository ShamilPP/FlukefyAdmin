        ...
        Consumer<ProductsProvider>(builder: (ctx, provider, child) {
          ...
          if (status == Status.loading) {
            return SizedBox(
              ...
              child: Center(child: SpinKitFadingCube(color: DefaultColors.primaryColor, size: 25)),
            );
    ...
    return FadeAnimation(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [BoxShadow(color: DefaultColors.primaryColor.withOpacity(.4), blurRadius: 2, offset: const Offset(0, 2))],
        ),
        child: Material(
          borderRadius: BorderRadius.circular(10),
          color: Colors.white,
